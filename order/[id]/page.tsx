      ...
      <div style={S.body}>
        ...
        <div style={S.card}>
          ...
          {order.items?.map((item, i) => (
            <div key={i} style={{ display: 'flex', justifyContent: 'space-between', fontSize: 13, fontWeight: 600, color: 'rgba(255,255,255,0.4)', padding: '5px 0', borderBottom: i < order.items.length - 1 ? '1px solid #F5F5F0' : 'none' }}>
